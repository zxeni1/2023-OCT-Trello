...
def update_card(card_id):
    ...
    if card:
        if str(card.user_id) != get_jwt_identity():
            return {"error": "Only the owner can edit the cardeyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmcmVzaCI6ZmFsc2UsImlhdCI6MTcwODczNzgyMSwianRpIjoiNjYzYjJlZjEtNGM2Ni00MjVmLThkYTQtOTViOTg0NDYxM2NkIiwidHlwZSI6ImFjY2VzcyIsInN1YiI6IjIiLCJuYmYiOjE3MDg3Mzc4MjEsImNzcmYiOiI2NWViNzkxOC0xNTU3LTQ3NzItYmJiNS1kMTlhNGQ5NWIzYWMiLCJleHAiOjE3MDg4MjQyMjF9.ncQ0o17vGDrhBm0ohJ3POmo05XyJqktySlTvrBQITZg"}, 403
        # update the fields
